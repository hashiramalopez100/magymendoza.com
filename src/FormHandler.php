...
class FormHandler
{
	...
	public function __construct()
	{
		...
		$from_name = 'Magy Mendoza';
   		$this->mailer->setFrom($from_email,$from_name, FALSE); //,'Contact Form',false

        //SMTP Settings
        $this->mailer->isSMTP();
        $this->mailer->Host = "smtp.gmail.com";
        $this->mailer->SMTPAuth = true;
        $this->mailer->Username = "mhdwpage@gmail.com"; //enter you email address
        $this->mailer->Password = 'NzxT3DG5om9GG80j'; //enter you email password
        $this->mailer->Port = 465;
        $this->mailer->SMTPSecure = "ssl";
        //Email Settings
        $this->mailer->isHTML(true);
        //$this->mailer->addAddress("mhdwpage@gmail.com"); //enter you email address
